...
- [x] 1. Set up project structure and configuration constants
  - [x] 1.1 Create config.h with all application constants
...
- [x] 2. Implement credential storage module
  - [x] 2.1 Create credential_store.h with WiFiCredentials struct and function declarations
  ...
  - [x] 2.2 Implement credential_store.cpp using FlashStorage library
  ...
  - [x] 2.3 Write property test for credential round-trip (Property 1)
  ...
  - [x] 2.4 Write property test for failed credentials not persisted (Property 2)
...
- [x] 3. Implement WiFi manager module
  - [x] 3.1 Create wifi_manager.h with function declarations
  ...
  - [x] 3.2 Implement wifi_manager.cpp using WiFi101 library
...
- [x] 4. Implement health client module
  - [x] 4.1 Create health_client.h with HealthResult struct and function declarations
  ...
  - [x] 4.2 Implement health_client.cpp with HTTP GET and JSON parsing
  ...
  - [x] 4.3 Write property test for JSON parsing correctness (Property 3)
  ...
  - [x] 4.4 Write property test for invalid JSON handling (Property 4)
  ...
  - [x] 4.5 Write property test for missing fields detection (Property 5)
  ...
  - [x] 4.6 Write property test for health cache behavior (Property 6)
  ...
  - [x] 4.7 Write property test for retry logic bounds (Property 8)
...
- [x] 6. Implement web server module
  - [x] 6.1 Create web_server.h with mode enum and function declarations
  ...
  - [x] 6.2 Implement HTTP request parsing in web_server.cpp
  ...
  - [x] 6.3 Implement config form HTML generation and serving
  ...
  - [x] 6.4 Implement landing page HTML generation and serving
  ...
  - [x] 6.5 Write property test for landing page HTML content (Property 7)
  ...
  - [x] 6.6 Write unit tests for URL decoding
...
- [x] 7. Implement main sketch with state machine
  - [x] 7.1 Create wifi-config-app.ino with setup() and loop()
  ...
  - [x] 7.2 Implement AP mode loop logic
  ...
  - [x] 7.3 Implement STA mode loop logic
    - Poll web server for incoming requests
