...
- [ ] 1. Implement temperature conversion utility and sensor poller
  - [ ] 1.1 Create temperature conversion utility header
  ...
  - [ ]* 1.2 Write property test for temperature conversion
  ...
  - [ ] 1.3 Create sensor poller module
...
- [ ] 2. Implement running average module
  - [ ] 2.1 Create running average pure logic header for testing
  ...
  - [ ]* 2.2 Write property test for running average correctness
  ...
  - [ ]* 2.3 Write property test for minimum sample threshold
  ...
  - [ ] 2.4 Create running average Arduino module
...
- [ ] 3. Implement NTP client module
  - [ ] 3.1 Create NTP format pure logic header for testing
  ...
  - [ ]* 3.2 Write property test for ISO 8601 timestamp format
  ...
  - [ ] 3.3 Create NTP client Arduino module
...
- [ ] 5. Implement reading cache module
  - [ ] 5.1 Create reading cache pure logic header for testing
  ...
  - [ ]* 5.2 Write property test for reading cache capacity invariant
  ...
  - [ ]* 5.3 Write property test for ring buffer FIFO order
  ...
  - [ ] 5.4 Create reading cache Arduino module
...
- [ ] 6. Implement server reporter module
  - [ ] 6.1 Create JSON serializer pure logic header for testing
  ...
  - [ ] 6.3 Create response parser pure logic header for testing
  ...
  - [ ]* 6.4 Write property test for response parser
  ...
  - [ ] 6.5 Create server reporter Arduino module
...
- [ ] 8. Integrate modules into main sketch and add OLED display updates
  - [ ] 8.1 Add OLED display helper functions for hygrometer status
  ...
  - [ ] 8.2 Integrate NTP sync into STA mode boot sequence
  ...
  - [ ] 8.3 Integrate sensor polling and running average into STA mode loop
  ...
  - [ ] 8.4 Integrate reading cache and server reporting into STA mode loop
  ...
  - [ ] 8.5 Initialize sensor and cache modules in setup
...
- [ ] 9. Update test build configuration
  - [ ] 9.1 Update CMakeLists.txt with new test targets
  ...
  - [ ] 9.2 Add mock headers for new Arduino dependencies
